...
if (isset($_SESSION['hid'])) {
  header("location:hospitalpage.html");
...
<body>
    ...
    <header class="home-header">
        <nav class="home-nav">
            ...
            <ul class="home-nav-list">
                ...
                <li class="home-nav-item">
                    <a href="login.php" class="home-nav-link login-btn active">
    ...
    <div class="main-content">
        <div class="login-hero">
            <h1>Welcome Back</h1>
            <p>Login to manage your blood donation activities</p>
       </div>
        ...
        <section class="login-section">
            <div class="login-container">
                ...
                <div class="login-tabs">
                    <button class="login-tab active" data-form="receiver">Receiver Login</button>
                    <button class="login-tab" data-form="hospital">Hospital Login</button>
      </div>

                <div class="login-form-container">
                    <!-- Receiver Login Form -->
                    <form class="login-form active" id="receiverForm" action="file/receiverLogin.php" method="post">
                        <h2 class="form-title">Receiver Login</h2>
                        ...
                        <button type="submit" name="rlogin" class="btn btn-login">
                            <i class="fas fa-sign-in-alt"></i> Login
                        </button>
                    ...
                    <!-- Hospital Login Form -->
                    <form class="login-form" id="hospitalForm" action="file/hospitalLogin.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="hpassword" class="form-control" placeholder="Password" required>
    </div>
                        <button type="submit" name="hlogin" class="btn btn-login">
                            <i class="fas fa-sign-in-alt"></i> Login
                        </button>
                        <div class="register-link">
                            Don't have an account? <a href="register.php">Register Now</a>
