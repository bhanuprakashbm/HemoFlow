...
A web application for managing blood bank operations and connecting donors with recipients.
...
4. Import the database from sql/bloodbank.sql
5. Access the application at http://localhost/Blood-Bank-Management-System/
